...
def smooth_bathy(grid_file,rx0max,method):
    ...
    if method=='positive':
        h_smooth = smoothing_Positive_rx0(mask_rho,h,rx0max)
        ...
        h_smooth = smoothing_PlusMinus_rx0(mask_deep,h,rx0max,areaMatrix)
    elif method=='laplace':
...
if __name__ == "__main__":
    ...
    grid_file='../waom10Grids/sledge_grd.nc'
    method ='positiveVolume'
    rx0max =0.2
